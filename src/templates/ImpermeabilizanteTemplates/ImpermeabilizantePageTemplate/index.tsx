...
export default function ImpermeabilizantePageTemplate({
  ...
  const impermeabilizantesLinks = impermeabilizantesJson.map((imper) => {
    return {href: imper.link, text: imper.titulo}
  });
    ...
    >
      <Container>
        ...
        <Content>
          ...
          <AsideNav title="IMPERMEABILIZANTES" links={impermeabilizantesLinks} />
        </Content>
      </Container>
